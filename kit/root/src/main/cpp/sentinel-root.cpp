...
JNIEXPORT jboolean JNICALL Java_com_rs_kit_root_detector_RootDetector_checkApps(
...
Java_com_rs_kit_root_detector_RootDetector_checkBinaries(JNIEnv *env, jobject) {
...
JNIEXPORT jboolean JNICALL
Java_com_rs_kit_root_detector_RootDetector_checkMounts(JNIEnv *env, jobject) {
...
JNIEXPORT jboolean JNICALL
Java_com_rs_kit_root_detector_RootDetector_checkSuCommand(JNIEnv *env,
                                                          jobject) {
